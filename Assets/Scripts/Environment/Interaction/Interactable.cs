...
public abstract class Interactable : NetworkBehaviour, IInteractable
{
    ...
    [Tooltip("Should this interactable be controlled by floor clear events? (Enable after all enemies defeated)")]
    [SerializeField] protected bool controlledByFloorClear = false;
    ...
    /// <summary>
    /// Returns whether this interactable should be controlled by floor clear events.
    /// </summary>
    public bool IsControlledByFloorClear()
    {
        return controlledByFloorClear;
    }
